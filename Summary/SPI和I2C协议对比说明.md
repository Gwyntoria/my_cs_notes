...
上述示例代码是基于 Linux 系统下的**I2C设备文件**（如/dev/i2c-1），而具体的设备文件路径和 I2C 总线编号可能会有所不同，需要根据实际情况进行调整。
...
2. 地址寻址：在 I2C 中，**每个从设备都有唯一的7位或10位地址，主设备使用地址来选择特定的从设备进行通信**。而在 SPI 中，**每个从设备都有一个片选线，主设备通过片选线来选择与之通信的特定从设备**。
