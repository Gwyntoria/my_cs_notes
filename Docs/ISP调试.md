...
1. Demosaic
2. 3DNR 前 Sharpen
3. 3DNR 后 Sharpen（Hi3516CV500/Hi3516EV200/Hi3516EV300/ Hi3518EV300 不支持）
4. NR
5. DPC
6. 3DNR
...
1. AWB
2. CCM
3. CLUT（Hi3516EV200/Hi3516EV300/Hi3518EV300 不支持）
...
而图像的成像亮度，则还包括 AE 阶段之后的 Gamma、Tone mapping、Multi Frame HDR……图像处理阶段
...
1. 先将`LumaTarget`的值调至 0，将高光抑制表现到最大。（表现在强光源被显示黑色）
