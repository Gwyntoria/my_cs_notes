...
![image-20230331140039343](./assets/hi3516dv300固件烧录指南/image-20230331140039343.png)
...
![image-20221208133548351](./assets/hi3516dv300固件烧录指南/image-20221208133548351.png)

## 2. 通过`HiBurn`烧写

### 2.1 选择设备

![image-20230323160019437](./assets/hi3516dv300固件烧录指南/image-20230323160019437.png)

### 2.2 配置网络信息

1. 选择网络传输（USB 传输和串口传输速度很慢）
   ![image-20230407100404044](./assets/hi3516dv300固件烧录指南/image-20230407100404044.png)
2. 选择相应串口和`tftp server`的 IP 地址，配置板端的网络信息
   ![image-20230407100440771](./assets/hi3516dv300固件烧录指南/image-20230407100440771.png)

### 2.3 烧写步骤

#### 2.3.1 选择按分区烧写

![image-20230323181751192](./assets/hi3516dv300固件烧录指南/image-20230323181751192.png)

#### 2.3.2 配置分区信息和烧录

1. 添加分区

   ![image-20230407100635616](./assets/hi3516dv300固件烧录指南/image-20230407100635616.png)

2. 选择各分区对应的文件

   ![image-20230407100653955](./assets/hi3516dv300固件烧录指南/image-20230407100653955.png)

3. 选择和板子相匹配的设备类型（spi nand 或者 spi nor 等）

   ![image-20230407100839690](./assets/hi3516dv300固件烧录指南/image-20230407100839690.png)

4. 选择适配的文件系统类型

   ![image-20230407101054034](./assets/hi3516dv300固件烧录指南/image-20230407101054034.png)

5. 配置正确的文件长度

   ![image-20230407101137157](./assets/hi3516dv300固件烧录指南/image-20230407101137157.png)

6. 勾选需要烧录的内容（kernel，rootfs 等）

   ![image-20231007184312399](./assets/hi3516dv300固件烧录指南/image-20231007184312399.png)
...
![image-20231007184747470](./assets/hi3516dv300固件烧录指南/image-20231007184747470.png)
...
1. 选择烧写方式及 flash 类型
   ...
   ![image-20231007190212785](./assets/hi3516dv300固件烧录指南/image-20231007190212785.png)

2. 选择需要烧录的 u-boot 镜像文件

   ![image-20231007190522951](./assets/hi3516dv300固件烧录指南/image-20231007190522951.png)
...
![img](./assets/hi3516dv300固件烧录指南/v2-5cc20b5101379eeff56ec0864735895b_720w.webp)

eMMC 设备烧录分区信息表：

![img](./assets/hi3516dv300固件烧录指南/v2-fa3ef24994c1ffb4ab71cc4d6ebfd590_720w.webp)
